        ...
        <div class="bg-white rounded-xl shadow-sm">
            <form action="{{ route('customer.pets.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="form-input w-full @error('name') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="text" name="breed" id="breed" value="{{ old('breed') }}" class="form-input w-full @error('breed') border-red-500 @enderror">
                        ...
                        <div>
                            ...
                            <input type="number" name="age" id="age" value="{{ old('age') }}" min="0" step="0.1" class="form-input w-full @error('age') border-red-500 @enderror">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="notes" id="notes" rows="4" class="form-input w-full @error('notes') border-red-500 @enderror" placeholder="{{ __('messages.special_requirements_placeholder') }}">{{ old('notes') }}</textarea>
                ...
                <div class="p-6 bg-gray-50 rounded-b-xl border-t flex justify-end gap-4">
                    ...
                    <button type="submit" class="btn-gradient inline-flex items-center px-4 py-2 rounded-md font-semibold text-xs uppercase tracking-widest transition">{{ __('messages.add_pet') }}</button>
                </div>
            </form>
        </div>
    </div>
