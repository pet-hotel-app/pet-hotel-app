<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Add New Pet') }}</h2></x-slot>
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-6">Pet Information</h3>
                    ...
                    <form action="{{ route('customer.pets.store') }}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="notes" id="notes" rows="4" class="w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 @error('notes') border-red-500 @enderror" placeholder="Any special requirements, medical conditions, etc.">{{ old('notes') }}</textarea>
                        ...
                        <div class="flex items-center justify-end gap-4">
                            ...
                            <button type="submit" class="inline-flex items-center px-4 py-2 bg-[#FFB6C9] border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-pink-500 transition">Add Pet</button>
                        </div>
                    </form>
                </div>
            </div>
