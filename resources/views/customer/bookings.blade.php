<x-app-layout>
    <x-slot name="header"><h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('My Bookings') }}</h2></x-slot>
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-800 mb-6">Booking History</h3>
                    ...
                    <div class="space-y-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="grid grid-cols-2 gap-4 text-sm text-gray-600">
                                        <div>
                                            ...
                                            <p>{{ $booking->room ? $booking->room->code : 'Not assigned' }}</p>
                                        </div>
                                        <div>
                        ...
                        <div class="text-center py-12">
                            ...
                            <p class="mt-4 text-gray-500">No bookings yet.</p>
                            <a href="{{ route('customer.rooms') }}" class="mt-4 inline-block px-4 py-2 bg-[#FFB6C9] text-white rounded-md hover:bg-pink-500 transition">Book a Room</a>
                        </div>
                        @endforelse
                    </div>
