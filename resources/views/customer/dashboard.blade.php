<x-app-layout>
    <div class="py-6">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative overflow-hidden bg-gradient-to-r from-pink-500 to-purple-600 rounded-xl shadow-lg mb-6">
                ...
                <div class="relative px-6 py-8 md:px-8 md:py-10">
                    <div class="flex items-center justify-between">
                        <div class="text-white">
                            ...
                            <p class="text-white/90 mb-4">Manage your pets and bookings easily</p>
                            <a href="{{ route('customer.rooms') }}" class="inline-flex items-center px-6 py-2.5 bg-white text-purple-600 rounded-lg font-semibold text-sm shadow hover:shadow-lg transform hover:-translate-y-0.5 transition-all">
            ...
            <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-md transition-shadow p-4">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ route('customer.pets.index') }}" class="text-gray-400 hover:text-gray-600">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                    </div>
                    <p class="text-xs text-gray-600 mb-1">My Pets</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $myPets }}</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-md transition-shadow p-4">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ route('customer.bookings') }}" class="text-gray-400 hover:text-gray-600">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                    </div>
                    <p class="text-xs text-gray-600 mb-1">Bookings</p>
                    <p class="text-2xl font-bold text-gray-900">{{ $myBookings }}</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-md transition-shadow p-4">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ route('customer.messages.index') }}" class="text-gray-400 hover:text-gray-600">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                    </div>
                    <p class="text-xs text-gray-600 mb-1">Messages</p>
                ...
                <div class="bg-white rounded-lg shadow hover:shadow-md transition-shadow p-4">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <a href="{{ route('customer.invoices.index') }}" class="text-gray-400 hover:text-gray-600">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path>
                            </svg>
                        </a>
                    </div>
                    <p class="text-xs text-gray-600 mb-1">Invoices</p>
                    <p class="text-2xl font-bold text-gray-900">
                        @php
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                <a href="{{ route('customer.rooms') }}" class="group bg-white rounded-lg shadow hover:shadow-lg transition-all p-5">
                    <div class="flex items-center mb-3">
                        <div class="p-3 bg-gradient-to-br from-pink-100 to-pink-200 rounded-lg group-hover:from-pink-500 group-hover:to-pink-600 transition-all">
                    ...
                    <h3 class="font-bold text-gray-900 mb-1">Book a Room</h3>
                    <p class="text-sm text-gray-600">Find the perfect room for your pet</p>
                </a>

                <a href="{{ route('customer.pets.index') }}" class="group bg-white rounded-lg shadow hover:shadow-lg transition-all p-5">
                    <div class="flex items-center mb-3">
                        <div class="p-3 bg-gradient-to-br from-purple-100 to-purple-200 rounded-lg group-hover:from-purple-500 group-hover:to-purple-600 transition-all">
                    ...
                    <h3 class="font-bold text-gray-900 mb-1">My Pets</h3>
                    <p class="text-sm text-gray-600">Manage your pet information</p>
                </a>

                <a href="{{ route('customer.profile') }}" class="group bg-white rounded-lg shadow hover:shadow-lg transition-all p-5">
                    <div class="flex items-center mb-3">
                        <div class="p-3 bg-gradient-to-br from-indigo-100 to-indigo-200 rounded-lg group-hover:from-indigo-500 group-hover:to-indigo-600 transition-all">
                    ...
                    <h3 class="font-bold text-gray-900 mb-1">My Profile</h3>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="font-semibold text-gray-900">{{ $booking->pet->name }}</p>
                                    <p class="text-sm text-gray-600">
                                        {{ \Carbon\Carbon::parse($booking->start_date)->format('M d') }} - {{ \Carbon\Carbon::parse($booking->end_date)->format('M d, Y') }}
                                    </p>
                                </div>
                            </div>
                            <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $booking->status == 'confirmed' ? 'bg-green-100 text-green-700' : ($booking->status == 'pending' ? 'bg-yellow-100 text-yellow-700' : 'bg-gray-100 text-gray-700') }}">
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('customer.bookings') }}" class="inline-flex items-center text-sm font-semibold text-pink-600 hover:text-pink-700">
                            View All Bookings
            ...
            <div class="bg-white rounded-lg shadow p-10 text-center">
                <div class="max-w-sm mx-auto">
                    ...
                    <p class="text-gray-600 mb-4">Book your first room and give your pet a comfortable stay!</p>
                    <a href="{{ route('customer.rooms') }}" class="inline-flex items-center px-6 py-2.5 bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all shadow">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
