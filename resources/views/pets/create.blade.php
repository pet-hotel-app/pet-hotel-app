            ...
            <form action="{{ route('pets.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="species" id="species" value="{{ old('species') }}" placeholder="e.g., Dog, Cat, Bird" class="form-input w-full @error('species') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="age" id="age" value="{{ old('age') }}" min="0" class="form-input w-full @error('age') border-red-500 @enderror">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="3" class="form-input w-full @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                ...
                <div class="mt-8 flex items-center justify-end gap-4">
                    ...
                    <button type="submit" class="btn-gradient inline-flex items-center px-4 py-2 rounded-md font-semibold text-xs uppercase tracking-widest transition">{{ __('messages.create_pet') }}</button>
                </div>
            </form>
        </div>
    </div>
