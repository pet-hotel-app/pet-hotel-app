                ...
                <div class="p-6">
                    <form action="{{ route('pets.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="species" id="species" value="{{ old('species') }}" placeholder="e.g., Dog, Cat, Bird"
                        ...
                        <div class="mb-6">
                            ...
                            <textarea name="notes" id="notes" rows="3"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500 @error('notes') border-red-500 @enderror">{{ old('notes') }}</textarea>
                            @error('notes')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
