            ...
            <form action="{{ route('pets.update', $pet) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="owner_id" id="owner_id" required class="form-input w-full @error('owner_id') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="text" name="species" id="species" value="{{ old('species', $pet->species) }}" class="form-input w-full @error('species') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        <input type="number" name="age" id="age" value="{{ old('age', $pet->age) }}" min="0" class="form-input w-full @error('age') border-red-500 @enderror">
                    ...
                    <div>
                        ...
                        @if($pet->image)
                            <img src="{{ asset('storage/' . $pet->image) }}" alt="{{ $pet->name }}" class="mt-4 h-32 w-auto rounded-md">
                        @endif
                    </div>
                    <div class="md:col-span-2">
                        <label for="notes" class="block text-sm font-medium text-gray-700 mb-2">{{ __('messages.notes') }}</label>
                        <textarea name="notes" id="notes" rows="3" class="form-input w-full @error('notes') border-red-500 @enderror">{{ old('notes', $pet->notes) }}</textarea>
